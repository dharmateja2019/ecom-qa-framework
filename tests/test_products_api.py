...
def test_single_product_has_valid_price_and_title(product_id,product_catalogue):
  get_response = product_catalogue[product_id-1]  # Using fixture to get the catalogue
  product = get_response
